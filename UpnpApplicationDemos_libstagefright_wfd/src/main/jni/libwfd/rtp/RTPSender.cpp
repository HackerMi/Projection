...
status_t RTPSender::queueBuffer(
    ...
    status_t err;
    ALOGE("RTPSender::queueBuffer, mode %d", mode);
...
status_t RTPSender::queueRawPacket(
    ...
    ALOGE("RTPSender::queueRawPacket");
...
status_t RTPSender::queueTSPackets(
    ...
    ALOGE("RTPSender::queueTSPackets");
...
status_t RTPSender::queueAVCBuffer(
    ...
    ALOGE("RTPSender::queueAVCBuffer");
...
status_t RTPSender::sendRTPPacket(
    ...
    if (err != OK) {
        ALOGE("RTPSender::sendRTPPacket, err %d", err);
        return err;
    }
