...
void WifiDisplaySource::onMessageReceived(const sp<AMessage> &msg) {
    switch (msg->what()) {
        ...
        {
            uint32_t replyID;
            ALOGE("onMessageReceived kWhatStart");
        ...
        case kWhatRTSPNotify:
        {
            ...
            switch (reason) {
                ...
                {
                    int32_t sessionID;
                    ALOGE("onMessageReceived kWhatRTSPNotify kWhatError");
                    ...
                    if (sessionID == mClientSessionID) {
                        mClientSessionID = 0;
                        ALOGE("onMessageReceived kWhatRTSPNotify::onDisplayError");
                ...
                {
                    int32_t sessionID;
                    ALOGE("onMessageReceived ANetworkSession kWhatClientConnected");
                    CHECK(msg->findInt32("sessionID", &sessionID));
                ...
                {
                    ALOGE("onMessageReceived ANetworkSession::kWhatData");
                    status_t err = onReceiveClientData(msg);

                    if (err != OK) {
                        ALOGE("onMessageReceived ANetworkSession::onDisplayError");
                        mClient->onDisplayError(
                                IRemoteDisplayClient::kDisplayErrorUnknown);
                    }
        ...
        case kWhatStop:
        {
            ...
            ALOGE("onMessageReceived kWhatStop");
        ...
        case kWhatPause:
        {
            uint32_t replyID;
            CHECK(msg->senderAwaitsResponse(&replyID));
            ALOGE("onMessageReceived kWhatPause");
        ...
        case kWhatResume:
        {
            uint32_t replyID;
            CHECK(msg->senderAwaitsResponse(&replyID));
            ALOGE("onMessageReceived kWhatResume");
        ...
        {
            mReaperPending = false;
            ALOGE("onMessageReceived kWhatReapDeadClients");
            ...
            if (mClientInfo.mPlaybackSession->getLastLifesignUs()
                ...
                mClientSessionID = 0;
                ALOGE("onMessageReceived kWhatReapDeadClients::onDisplayError");
                mClient->onDisplayError(
                        IRemoteDisplayClient::kDisplayErrorUnknown);
            } else {
                scheduleReaper();
        ...
        case kWhatPlaybackSessionNotify:
        {
            ...
            ALOGE("onMessageReceived kWhatPlaybackSessionNotify");
            ...
            if (what == PlaybackSession::kWhatSessionDead) {
                ...
                ALOGE("onMessageReceived kWhatPlaybackSessionNotify onDisplayError");
                mClient->onDisplayError(
                        IRemoteDisplayClient::kDisplayErrorUnknown);
            } else if (what == PlaybackSession::kWhatSessionEstablished) {
                mPlaybackSessionEstablished = true;
                ALOGE("onMessageReceived kWhatPlaybackSessionNotify, PlaybackSession::kWhatSessionEstablished");

                if (mClient != NULL) {
                    if (!mSinkSupportsVideo) {
                        ALOGE("onMessageReceived kWhatPlaybackSessionNotify, PlaybackSession::kWhatSessionEstablished, onDisplayConnected 1");
                        ...
                        CHECK(VideoFormats::GetConfiguration(
                                    ...
                                    NULL /* interlaced */));
                        ALOGE("onMessageReceived kWhatPlaybackSessionNotify, PlaybackSession::kWhatSessionEstablished, onDisplayConnected 2");
                        mClient->onDisplayConnected(
                ...
                ALOGE("onMessageReceived kWhatPlaybackSessionNotify, PlaybackSession::kWhatSessionEstablished, finish play begin");

                finishPlay();
                ALOGE("onMessageReceived kWhatPlaybackSessionNotify, PlaybackSession::kWhatSessionEstablished, finish play end");

                if (mState == ABOUT_TO_PLAY) {
                    mState = PLAYING;
                }
            } else if (what == PlaybackSession::kWhatSessionDestroyed) {
                ALOGE("onMessageReceived kWhatPlaybackSessionNotify, PlaybackSession::kWhatSessionDestroyed");
                disconnectClient2();
            } else {
                ALOGE("onMessageReceived kWhatPlaybackSessionNotify, PlaybackSession::kWhatBinaryData");
        ...
        case kWhatKeepAlive:
        {
            int32_t sessionID;
            CHECK(msg->findInt32("sessionID", &sessionID));
            ALOGE("onMessageReceived kWhatKeepAlive");
        ...
        {
            ALOGE("onMessageReceived kWhatTeardownTriggerTimedOut");
        ...
        case kWhatHDCPNotify:
        {
            ...
            switch (msgCode) {
                ...
                default:
                {
                    ...
                    ALOGE("onMessageReceived kWhatHDCPNotify default onDisplayError");
                    mClient->onDisplayError(
                            IRemoteDisplayClient::kDisplayErrorUnknown);
                    break;
                }
        ...
        {
            ALOGE("onMessageReceived kWhatFinishStop2");
            finishStop2();
            break;
        }
...
status_t WifiDisplaySource::onTeardownRequest(
    ...
    if (mState == AWAITING_CLIENT_TEARDOWN) {
        ...
        ALOGE("WifiDisplaySource::onTeardownRequest onDisplayError");
