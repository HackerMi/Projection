...
public class StreamTransport implements ServiceStub {
    ...
    public enum CurrentMediaCategory {
        ...
        V_TRACK_AWARE,
        V_TRACK_UNAWARE,
        V_STEAM_PROJECTION_VEDIO,
        V_STEAM_PROJECTION_AUDIO;
        ...
        private static final String CONST_V_STEAM_PROJECTION_VEDIO = "STEAM_PROJECTION_VEDIO";
        private static final String CONST_V_STEAM_PROJECTION_AUDIO = "STEAM_PROJECTION_AUDIO";
        ...
        public static CurrentMediaCategory retrieveType(String value) {
            ...
            if (value.equals(CONST_V_STEAM_PROJECTION_VEDIO)) {
                return V_STEAM_PROJECTION_VEDIO;
            }

            if (value.equals(CONST_V_STEAM_PROJECTION_AUDIO)) {
                return V_STEAM_PROJECTION_AUDIO;
            }
        ...
        public String getValue() {
            ...
            switch (this) {
                ...
                case V_STEAM_PROJECTION_VEDIO:
                    value = CONST_V_STEAM_PROJECTION_VEDIO;
                    break;

                case V_STEAM_PROJECTION_AUDIO:
                    value = CONST_V_STEAM_PROJECTION_AUDIO;
                    break;
    ...
    public interface Handler {
        UpnpError onGetDRMState(Long theInstanceID, GetDRMState_Result result);
        UpnpError onSyncStop(Long theInstanceID, String theStopTime, String theReferenceClockId);
        UpnpError onGetMediaInfo_Ext(Long theInstanceID, GetMediaInfo_Ext_Result result);
        ...
        UpnpError onSetSyncOffset(Long theInstanceID, String theNewSyncOffset);
        UpnpError onSyncPause(Long theInstanceID, String thePauseTime, String theReferenceClockId);
        UpnpError onGetPositionInfo(Long theInstanceID, GetPositionInfo_Result result);
        UpnpError onGetPlaylistInfo(Long theInstanceID, A_ARG_TYPE_PlaylistType thePlaylistType, GetPlaylistInfo_Result result);
        UpnpError onSetNextAVTransportURI(Long theInstanceID, String theNextURI, String theNextURIMetaData);
        UpnpError onSetPlayMode(Long theInstanceID, CurrentPlayMode theNewPlayMode);
        UpnpError onSeek(Long theInstanceID, A_ARG_TYPE_SeekMode theUnit, String theTarget);
        UpnpError onSetStaticPlaylist(Long theInstanceID, String thePlaylistData, Long thePlaylistDataLength, Long thePlaylistOffset, Long thePlaylistTotalLength, String thePlaylistMIMEType, String thePlaylistExtendedType, String thePlaylistStartObj, String thePlaylistStartGroup);
        ...
        UpnpError onSetRecordQualityMode(Long theInstanceID, String theNewRecordQualityMode);
        UpnpError onNext(Long theInstanceID);
        UpnpError onGetStateVariables(Long theInstanceID, String theStateVariableList, GetStateVariables_Result result);
        UpnpError onGetSyncOffset(Long theInstanceID, GetSyncOffset_Result result);
        UpnpError onSyncPlay(Long theInstanceID, TransportPlaySpeed theSpeed, A_ARG_TYPE_SeekMode theReferencePositionUnits, String theReferencePosition, String theReferencePresentationTime, String theReferenceClockId);
        UpnpError onRecord(Long theInstanceID);
        UpnpError onGetTransportInfo(Long theInstanceID, GetTransportInfo_Result result);
        UpnpError onPrevious(Long theInstanceID);
        UpnpError onAdjustSyncOffset(Long theInstanceID, String theAdjustment);
        UpnpError onGetDeviceCapabilities(Long theInstanceID, GetDeviceCapabilities_Result result);
        UpnpError onSetStateVariables(Long theInstanceID, String theAVTransportUDN, String theServiceType, String theServiceId, String theStateVariableValuePairs, SetStateVariables_Result result);
        UpnpError onSetStreamingPlaylist(Long theInstanceID, String thePlaylistData, Long thePlaylistDataLength, String thePlaylistMIMEType, String thePlaylistExtendedType, A_ARG_TYPE_PlaylistStep thePlaylistStep);
    ...
    private UpnpError handle_GetDRMState(ActionInfo info) {
        ...
        UpnpError error = _handler.onGetDRMState(theInstanceID, result);
    ...
    private UpnpError handle_SyncStop(ActionInfo info) {
        ...
        UpnpError error = _handler.onSyncStop(theInstanceID, theStopTime, theReferenceClockId);
        if (! error.equals(UpnpError.OK)) {
            return error;
        }
    ...
    private UpnpError handle_GetMediaInfo_Ext(ActionInfo info) {
        ...
        UpnpError error = _handler.onGetMediaInfo_Ext(theInstanceID, result);
        if (! error.equals(UpnpError.OK)) {
            return error;
        }
    ...
    private UpnpError handle_SetSyncOffset(ActionInfo info) {
        ...
        UpnpError error = _handler.onSetSyncOffset(theInstanceID, theNewSyncOffset);
        if (! error.equals(UpnpError.OK)) {
            return error;
        }
    ...
    private UpnpError handle_SyncPause(ActionInfo info) {
        ...
        UpnpError error = _handler.onSyncPause(theInstanceID, thePauseTime, theReferenceClockId);
        if (! error.equals(UpnpError.OK)) {
            return error;
        }
    ...
    private UpnpError handle_GetPlaylistInfo(ActionInfo info) {
        ...
        UpnpError error = _handler.onGetPlaylistInfo(theInstanceID, thePlaylistType, result);
        if (! error.equals(UpnpError.OK)) {
            return error;
        }
    ...
    private UpnpError handle_SetNextAVTransportURI(ActionInfo info) {
        ...
        UpnpError error = _handler.onSetNextAVTransportURI(theInstanceID, theNextURI, theNextURIMetaData);
        if (! error.equals(UpnpError.OK)) {
            return error;
        }
    ...
    private UpnpError handle_SetPlayMode(ActionInfo info) {
        ...
        UpnpError error = _handler.onSetPlayMode(theInstanceID, theNewPlayMode);
        if (! error.equals(UpnpError.OK)) {
            return error;
        }
    ...
    private UpnpError handle_SetStaticPlaylist(ActionInfo info) {
        ...
        UpnpError error = _handler.onSetStaticPlaylist(theInstanceID, thePlaylistData, thePlaylistDataLength, thePlaylistOffset, thePlaylistTotalLength, thePlaylistMIMEType, thePlaylistExtendedType, thePlaylistStartObj, thePlaylistStartGroup);
        if (! error.equals(UpnpError.OK)) {
            return error;
        }
    ...
    private UpnpError handle_SetRecordQualityMode(ActionInfo info) {
        ...
        UpnpError error = _handler.onSetRecordQualityMode(theInstanceID, theNewRecordQualityMode);
        if (! error.equals(UpnpError.OK)) {
            return error;
        }
    ...
    private UpnpError handle_GetStateVariables(ActionInfo info) {
        ...
        UpnpError error = _handler.onGetStateVariables(theInstanceID, theStateVariableList, result);
        if (! error.equals(UpnpError.OK)) {
            return error;
        }
    ...
    private UpnpError handle_GetSyncOffset(ActionInfo info) {
        ...
        UpnpError error = _handler.onGetSyncOffset(theInstanceID, result);
        if (! error.equals(UpnpError.OK)) {
            return error;
        }
    ...
    private UpnpError handle_SyncPlay(ActionInfo info) {
        ...
        UpnpError error = _handler.onSyncPlay(theInstanceID, theSpeed, theReferencePositionUnits, theReferencePosition, theReferencePresentationTime, theReferenceClockId);
        if (! error.equals(UpnpError.OK)) {
            return error;
        }
    ...
    private UpnpError handle_Record(ActionInfo info) {
        Long theInstanceID = (Long)info.getArgumentValue(_Record_ARG_InstanceID);

        UpnpError error = _handler.onRecord(theInstanceID);
        if (! error.equals(UpnpError.OK)) {
            return error;
        }
    ...
    private UpnpError handle_AdjustSyncOffset(ActionInfo info) {
        ...
        UpnpError error = _handler.onAdjustSyncOffset(theInstanceID, theAdjustment);
        if (! error.equals(UpnpError.OK)) {
            return error;
        }
    ...
    private UpnpError handle_SetStateVariables(ActionInfo info) {
        ...
        UpnpError error = _handler.onSetStateVariables(theInstanceID, theAVTransportUDN, theServiceType, theServiceId, theStateVariableValuePairs, result);
        if (! error.equals(UpnpError.OK)) {
            return error;
        }
    ...
    private UpnpError handle_SetStreamingPlaylist(ActionInfo info) {
        ...
        UpnpError error = _handler.onSetStreamingPlaylist(theInstanceID, thePlaylistData, thePlaylistDataLength, thePlaylistMIMEType, thePlaylistExtendedType, thePlaylistStep);
        if (! error.equals(UpnpError.OK)) {
            return error;
        }
