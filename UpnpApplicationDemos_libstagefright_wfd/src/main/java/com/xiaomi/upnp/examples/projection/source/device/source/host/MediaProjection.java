...
public class MediaProjection implements ServiceStub {
    ...
    public interface Handler {
        UpnpError onGetTransportURI(Long theInstanceID, GetTransportURI_Result result);
        UpnpError onStart(Long theInstanceID);
        UpnpError onStop(Long theInstanceID);
    }

    private UpnpError handle_GetTransportURI(ActionInfo info) {
        ...
        UpnpError error = _handler.onGetTransportURI(theInstanceID, result);
    ...
    private UpnpError handle_Start(ActionInfo info) {
        Long theInstanceID = (Long)info.getArgumentValue(_Start_ARG_InstanceID);

        UpnpError error = _handler.onStart(theInstanceID);
        if (! error.equals(UpnpError.OK)) {
            return error;
        }
