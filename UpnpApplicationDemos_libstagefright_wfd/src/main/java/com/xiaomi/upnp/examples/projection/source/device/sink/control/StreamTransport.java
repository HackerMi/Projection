...
public class StreamTransport extends AbstractService {
    ...
    public void GetDRMState(Long InstanceID, final GetDRMState_CompletedHandler handler) throws UpnpException {
    ...
    public void SyncStop(Long InstanceID, String StopTime, String ReferenceClockId, final SyncStop_CompletedHandler handler) throws UpnpException {
    ...
    public void GetMediaInfo_Ext(Long InstanceID, final GetMediaInfo_Ext_CompletedHandler handler) throws UpnpException {
    ...
    public void GetTransportSettings(Long InstanceID, final GetTransportSettings_CompletedHandler handler) throws UpnpException {
    ...
    public void SetSyncOffset(Long InstanceID, String NewSyncOffset, final SetSyncOffset_CompletedHandler handler) throws UpnpException {
    ...
    public void SyncPause(Long InstanceID, String PauseTime, String ReferenceClockId, final SyncPause_CompletedHandler handler) throws UpnpException {
    ...
    public void GetPositionInfo(Long InstanceID, final GetPositionInfo_CompletedHandler handler) throws UpnpException {
    ...
    public void GetPlaylistInfo(Long InstanceID, A_ARG_TYPE_PlaylistType PlaylistType, final GetPlaylistInfo_CompletedHandler handler) throws UpnpException {
    ...
    public void SetNextAVTransportURI(Long InstanceID, String NextURI, String NextURIMetaData, final SetNextAVTransportURI_CompletedHandler handler) throws UpnpException {
    ...
    public void SetPlayMode(Long InstanceID, CurrentPlayMode NewPlayMode, final SetPlayMode_CompletedHandler handler) throws UpnpException {
    ...
    public void Seek(Long InstanceID, A_ARG_TYPE_SeekMode Unit, String Target, final Seek_CompletedHandler handler) throws UpnpException {
    ...
    public void SetStaticPlaylist(Long InstanceID, String PlaylistData, Long PlaylistDataLength, Long PlaylistOffset, Long PlaylistTotalLength, String PlaylistMIMEType, String PlaylistExtendedType, String PlaylistStartObj, String PlaylistStartGroup, final SetStaticPlaylist_CompletedHandler handler) throws UpnpException {
    ...
    public void Play(Long InstanceID, TransportPlaySpeed Speed, final Play_CompletedHandler handler) throws UpnpException {
    ...
    public void GetMediaInfo(Long InstanceID, final GetMediaInfo_CompletedHandler handler) throws UpnpException {
    ...
    public void SetRecordQualityMode(Long InstanceID, String NewRecordQualityMode, final SetRecordQualityMode_CompletedHandler handler) throws UpnpException {
    ...
    public void Next(Long InstanceID, final Next_CompletedHandler handler) throws UpnpException {
    ...
    public void GetStateVariables(Long InstanceID, String StateVariableList, final GetStateVariables_CompletedHandler handler) throws UpnpException {
    ...
    public void GetSyncOffset(Long InstanceID, final GetSyncOffset_CompletedHandler handler) throws UpnpException {
    ...
    public void SyncPlay(Long InstanceID, TransportPlaySpeed Speed, A_ARG_TYPE_SeekMode ReferencePositionUnits, String ReferencePosition, String ReferencePresentationTime, String ReferenceClockId, final SyncPlay_CompletedHandler handler) throws UpnpException {
    ...
    public void Record(Long InstanceID, final Record_CompletedHandler handler) throws UpnpException {
    ...
    public void GetTransportInfo(Long InstanceID, final GetTransportInfo_CompletedHandler handler) throws UpnpException {
    ...
    public void Previous(Long InstanceID, final Previous_CompletedHandler handler) throws UpnpException {
    ...
    public void AdjustSyncOffset(Long InstanceID, String Adjustment, final AdjustSyncOffset_CompletedHandler handler) throws UpnpException {
    ...
    public void GetDeviceCapabilities(Long InstanceID, final GetDeviceCapabilities_CompletedHandler handler) throws UpnpException {
    ...
    public void SetStateVariables(Long InstanceID, String AVTransportUDN, String ServiceType, String ServiceId, String StateVariableValuePairs, final SetStateVariables_CompletedHandler handler) throws UpnpException {
    ...
    public void SetStreamingPlaylist(Long InstanceID, String PlaylistData, Long PlaylistDataLength, String PlaylistMIMEType, String PlaylistExtendedType, A_ARG_TYPE_PlaylistStep PlaylistStep, final SetStreamingPlaylist_CompletedHandler handler) throws UpnpException {
    ...
    public void Pause(Long InstanceID, final Pause_CompletedHandler handler) throws UpnpException {
    ...
    public void GetCurrentTransportActions(Long InstanceID, final GetCurrentTransportActions_CompletedHandler handler) throws UpnpException {
    ...
    public void SetAVTransportURI(Long InstanceID, String CurrentURI, String CurrentURIMetaData, final SetAVTransportURI_CompletedHandler handler) throws UpnpException {
